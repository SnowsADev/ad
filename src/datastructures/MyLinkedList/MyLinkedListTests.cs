...
namespace AD
{
    ...
    public partial class MyLinkedListTests
    {
        ...
        public void MyLinkedList_7_Internal_3_Insert()
        {
            ...
            // Assert
            Assert.IsNotNull(lst.head); //3
            Assert.IsNotNull(lst.head.next); //4
            Assert.IsNotNull(lst.head.next.next); //2
            Assert.IsNotNull(lst.head.next.next.next); //1
            Assert.IsNull(lst.head.next.next.next.next); //head
        }
